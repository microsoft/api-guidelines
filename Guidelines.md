...
## 1. Microsoft REST API Guidelines Working Group
...
## 3. Table of contents
<!-- TOC depthFrom:2 depthTo:4 orderedList:false updateOnSave:false withLinks:false -->
...
### 5.2. Guidelines for existing services and versioning of services
...
#### 8.4.3. Creating resources via PATCH (UPSERT semantics)
...
#### 8.4.4. Options and link headers
...
### 8.8. Specifying headers as query parameters
...
#### 8.10.1. Clients-specified response format
...
#### 8.10.2. Error condition responses
...
#### 10.3.1. Nested collections and properties
...
#### 10.6.1. Interpreting a sorting expression
...
#### 10.8.3. Additional considerations
...
### 10.9. Compound collection operations
...
### 11.4. Contents of a delta link response
...
## 12. JSON standardizations
### 12.1. JSON formatting standardization for primitive types
Primitive values MUST be serialized to JSON following the rules of [RFC4627][rfc-4627].

### 12.2. Guidelines for dates and times
#### 12.2.1. Producing dates
...
### 12.3. JSON serialization of dates and times
...
#### 12.3.2. Commentary on date formatting
...
### 13.3. Definition of a breaking change
...
### 14.1. Resource based long running operations (RELO)
...
### 14.2. Stepwise long running operations
...
#### 14.2.7. The typical flow, polling
...
#### 14.2.8. The typical flow, push notifications
...
### 14.3. Retention policy for operation results
...
## 15. Throttling, Quotas, and Limits
### 15.1. Principles
...
### 15.3. Retry-After and RateLimit Headers
...
### 15.6. Handling callers that ignore Retry-After headers
...
## 16. Push notifications via webhooks
### 16.1. Scope
...
### 16.7. Managing subscriptions programmatically
...
#### 16.7.4. Enumerating subscriptions
...
#### 19.1.1. Push notifications, per user flow
...
#### 19.1.2. Push notifications, firehose flow
