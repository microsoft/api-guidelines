...
## 2. Table of contents
<!-- TOC depthFrom:2 depthTo:3 orderedList:false updateOnSave:false withLinks:false -->
...
#### Creating resources via PATCH (UPSERT semantics)
