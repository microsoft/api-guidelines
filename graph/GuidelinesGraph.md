...
The top-level error code must match the HTTP response status codes, converted to camelCase, according to [rfc7231 (ietf.org)](https://datatracker.ietf.org/doc/html/rfc7231#section-6). The following examples demonstrate error modeling for common use cases:
