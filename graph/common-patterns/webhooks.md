...
By default the subscription service will forward OData query paremeters in the resource property. It is up to the workload to decide whether they want to support those or not.
